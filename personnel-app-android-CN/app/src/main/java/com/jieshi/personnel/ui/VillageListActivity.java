...
public class VillageListActivity extends AppCompatActivity {
    ...
    private void loadVillages() {
        ...
        try {
            ...
            // 显示数据数量
            android.util.Log.d("VillageList", "Loaded " + villageList.size() + " villages");
        } catch (Exception e) {
            e.printStackTrace();
            android.util.Log.e("VillageList", "Error loading villages: " + e.getMessage());
            android.widget.Toast.makeText(this, "加载村社区数据失败：" + e.getMessage(), android.widget.Toast.LENGTH_LONG).show();
        }
        
        // 如果数据为空，显示提示
        if (villageList.isEmpty()) {
            android.widget.Toast.makeText(this, "村社区数据为空", android.widget.Toast.LENGTH_LONG).show();
        }
    }
